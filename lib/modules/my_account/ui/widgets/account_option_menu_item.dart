...
class AccountOptionMenuItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final MyAccountNotifier myAccountNotifier = ref.read(myAccountNotifierProvider(initialState).notifier);
    ...
    return InkWell(
      ...
      onTap: () async {
        if (loginitem.route != null) {
         ...
         // await myAccountNotifier.navigateToRoute(context, loginitem.route!);
          ...
          if (loginitem.title == context.appString.logoutKey) {
            ...
            showCustomDialog(
              ...
              onOkClicked: () async {
                ...
                goBack(context);
              //  await myAccountNotifier.callLogoutAPI();
              },
            ...
            showCustomDialog(
              ...
              onOkClicked: () async {
                goBack(context);
               // await myAccountNotifier.callDeleteAccountAPI();
              },
              cancelBtnTitle: context.appString.cancelKey,
              onCancelClicked: () => goBack(context),
            );
