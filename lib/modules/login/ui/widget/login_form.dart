      ...
      child: NoInternetWidget(
        ...
        childWidget: Scaffold(
          ...
          body: Form(
            ...
            child: Column(
              children: <Widget>[
                const TopViewOnboardingLogin(isFromLogin: true),
                Expanded(
                  child: Padding(
                              ...
                              return CommonTextFormFieldWidget(
                                ...
                                onChange: (String value) {
                                  if (value.validatePasswordBool() ?? false) {
                                    ...
                                    loginCubit
                                        .handleValidationErrorMessageForPassword(
                                          context.appString.passAllCriteriaKey,
                                        );
                                  }
                                },
                                suffixIcon: CustomTextLabelWidget(
                                  ...
                                  style: context.textTheme.bodySmall?.copyWith(
                                    ...
                                    height: Dimens.lineHeight16.toLineHeight(
                                      Dimens.fontSize12,
                                    ),
                                    color: MainConfig
                                        .appColors
