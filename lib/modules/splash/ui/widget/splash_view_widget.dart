          ...
          children: <Widget>[
            ...
            Center(
              ...
              child: Container(
                ...
                width: Dimens.size282, // Set the width of the circle
                height: Dimens.size282, // Set the height of the circle
                decoration: const BoxDecoration(
                  color: AppColors.whiteColor, // Background color of the circle
                  shape: BoxShape.circle, // Makes the container circular
                ),

                child: Assets.svgs.icDukanSplashLogo.svg(
height: Dimens.size114,width: Dimens.size202
                ),
              ),
            ),
          ],
