...
@RoutePage()
class ViewCmsPage extends StatefulWidget {
  ...
  /// Creates a [ViewCmsPage] with the given [title] and [url].
  const ViewCmsPage(this.title, this.url, {super.key});

  @override
  ViewCmsPageState createState() => ViewCmsPageState();
}
///ViewCmsPageState
class ViewCmsPageState extends State<ViewCmsPage> {
