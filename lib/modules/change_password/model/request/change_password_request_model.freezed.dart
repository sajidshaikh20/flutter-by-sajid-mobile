...
class _$ChangePasswordRequestModelImpl implements _ChangePasswordRequestModel {
  ...
  @override
  String toString() {
    return 'ChangePasswordRequestModel(customerToken: $customerToken, currentPassword: $currentPassword, newPassword: $newPassword, languageId: $languageId, storeId: $storeId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, customerToken, currentPassword,
      newPassword, languageId, storeId);
...
abstract class _ChangePasswordRequestModel
  ...
  const factory _ChangePasswordRequestModel(
      ...
      final int? languageId,
      final int? storeId}) = _$ChangePasswordRequestModelImpl;
